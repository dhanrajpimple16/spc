  ...
  return (
    <div className='flex flex-col font-body z-50'>
      <div className='hidden md:flex flex-row items-center justify-between md:h-32 bg-white '>
        <div className='ml-16'>
          <img src={Logo} className='h-28 transform transition duration-300 hover:scale-110' />
        </div>
      ...
      <div className='hidden md:flex flex-row h-12 w-full md:relative drop-down items-center justify-center gap-6 bg-red-500 z-30 '>
        <div className="relative">
          ...
          {isDropdownOpen && (
            <div className="absolute left-0 py-2 w-48 bg-white border border-gray-200 rounded-md shadow-lg z-50"
              onMouseEnter={() => setIsDropdownOpen(true)}
              onMouseLeave={() => setIsDropdownOpen(false)}
            >
              {/* Dropdown Content */}
      ...
      <div className='md:hidden flex flex-row h-16 w-full justify-around items-center bg-white'>
        <img src={Logo} className='h-14' />
        <div className='flex items-center font-bold text-lg text-red-700' onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)}>
          MENU
      ...
      {isMobileMenuOpen && (
        <div className='md:hidden flex flex-col bg-red-500'>
          <div className='block px-4 py-2 text-white hover:bg-gray-800' onClick={() => toggleMobileDropdown('services')}>
            Our Services
            {isMobileDropdownOpen.services && (
              <div className="py-2 w-full bg-white border border-gray-200 rounded-md shadow-lg z-50">
                <Link to={'/'} className="block px-4 py-2 text-gray-800 hover:bg-gray-100">
                  Pest Control
                </Link>
                <Link to={'/'} className="block px-4 py-2 text-gray-800 hover:bg-gray-100">
          ...
          <div className='block px-4 py-2 text-white hover:bg-gray-800' onClick={() => toggleMobileDropdown('about')}>
            About Us
          ...
          <div className='block px-4 py-2 text-white hover:bg-gray-800' onClick={() => toggleMobileDropdown('areas')}>
            Areas We Service
            {isMobileDropdownOpen.areas && (
              <div className="py-2 w-full bg-white border border-gray-200 rounded-md shadow-lg z-50">
                <Link to={'/'} className="block px-4 py-2 text-gray-800 hover:bg-gray-100">
                  Mumbai
                </Link>
          ...
          <Link to={'/'} className='block px-4 py-2 text-white hover:bg-gray-800'>Special Offers</Link>
          <div className='block px-4 py-2 text-white hover:bg-gray-800' onClick={() => toggleMobileDropdown('contact')}>
            Contact Us
