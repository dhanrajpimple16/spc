  ...
  return (
   ...
   <div className='flex md:flex-row flex-col w-full fit bg-slate-300 p-12' >
    ...
    <div className='border-dashed border-8 border-gray-400 w-full sm:w-64 h-fit flex flex-col items-center m-4'>
      <p className='font-bold text-white md:text-5xl text-4xl text-center'>$30 off pest control</p>
      <p className='text-white md:text-3xl text-2xl md:p-0 p-2 text-center'>For New Customers</p>
      ...
      <p className='text-white md:mb-0 mb-2'>05/31/2024</p>
    </div>
  </div>
...
<div className='md:h-[450px] h-fit flex flex-col md:pb-0 pb-3  bg-slate-300 '>
   <div className='font-bold text-lg flex items-center ml-auto mr-auto border-b-8 border-red-600 w-[75px] text-center md:mb-0 mb-3 mt-2'>Review</div>

   <div className='flex md:flex-row flex-col w-full h-full md:justify-evenly items-center md:mt-8 md:gap-0 gap-4'>
  
 <div className='flex flex-col h-4/5 md:h-[350px] md:w-1/4 w-[80%] bg-white pt-4'>
