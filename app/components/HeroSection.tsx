...
const HeroSection = () => {
  ...
  backgroundPosition: "center",
     ...
     <div className='flex flex-col md:w-1/2  bg-right items-center justify-center h-full bg-slate-500 md:bg-transparent'>
   ...
   <button className='bg-btncolor text-white text-xl mt-4  md:mt-0 h-10 ml-4 p-2 font-semibold  hover:bg-white hover:text-red-700'>Switch to sound Pest Control</button>
      </div>
