...
const Footer = () => {
  return (
   <div className='flex flex-col items-center  justify-center  w-full md:mt-4 font-body'>
    <div className='flex md:flex-row text-center flex-col w-full bg-red-600 h-fit p-8 items-center justify-center md:gap-0 gap-2'>
...
<div className='flex md:flex-row flex-col md:justify-evenly bg-gray-800 w-full md:items-start  md:p-6 items-center'>
<div className='flex flex-col md:w-72 w-full
gap-4  items-center p-5 md:p-0'>
...
<div className='md:hidden flex flex-row p-5  w-full justify-center '>
<div className='md:flex flex-col  w-1/2 mt-5'>
...
<div className=' md:flex flex-col  w-1/2  mt-5'>
 <p  className='font-blod text-2xl text-white '><span className='underline decoration-red-500 '>Qui</span>ck link</p>
 <div className='flex flex-col'>
...
<div className='hidden  md:flex flex-col gap-5 w-72 mt-5'>
 <div className='font-blod text-2xl text-white '><span className='underline decoration-red-500 '>Our</span>   Service</div>
 <div className='flex flex-col'>
<p className='text-white'>Pest Control Services</p>
<p className='text-white'>Termite Control</p>
...
<div className='hidden md:flex flex-col gap-5 w-52  mt-5'>
 <p  className='font-blod text-2xl text-white '><span className='underline decoration-red-500 '>Qui</span>ck link</p>
 <div className='flex flex-col'>
<p className='text-white'>Home</p>
<p className='text-white'>About</p>
...
<div className='flex flex-col md:w-96 w-full p-6   md:mt-0 mt-5'>
<p className='font-blod text-2xl text-white '><span className='underline decoration-red-500 '>Get</span> in Touch</p>
<div>
